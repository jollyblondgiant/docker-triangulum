...
}catch (e12036){var _e__11789__auto__ = e12036;
return false;
}})();
...
}catch (e12038){var _e__11789__auto__ = e12038;
return false;
}})();
...
}catch (e12040){var _e__11789__auto__ = e12040;
return false;
}}
}
});
...
var vec__12042 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12042,(0),null);
var name = cljs.core.nth.call(null,vec__12042,(1),null);
...
return cljs.core.some.call(null,(function (p1__12045_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12045_SHARP_);
}),template);
});
