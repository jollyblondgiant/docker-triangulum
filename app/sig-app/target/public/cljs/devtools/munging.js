...
var o11933 = temp__5802__auto__;
var temp__5802__auto____$1 = (o11933["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o11934 = temp__5802__auto____$1;
return (o11934["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11782__auto__ = f;
return (o__11782__auto__["toString"]).call(o__11782__auto__);
} else {
return "";
}
...
try{var o__11782__auto___11937 = t;
(o__11782__auto___11937["cljs$lang$ctorPrWriter"]).call(o__11782__auto___11937,t,writer);
}catch (e11936){var __11938 = e11936;
}
...
var char_code = (function (){var o__11782__auto__ = (new String(char$));
return (o__11782__auto__["charCodeAt"]).call(o__11782__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11782__auto__ = String;
return (o__11782__auto__["fromCharCode"]).call(o__11782__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11939 = num_code;
switch (G__11939) {
case (1):
return (185);
...
var o__11782__auto__ = String;
return (o__11782__auto__["fromCharCode"]).call(o__11782__auto__,superscript_code);
});
/**
...
}catch (e11941){var _e__11789__auto__ = e11941;
return false;
}})())){
...
var vec__11942 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11942,(0),null);
...
var or__5002__auto__ = (function (){var temp__5802__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5802__auto__)){
...
var len__5726__auto___11951 = arguments.length;
var i__5727__auto___11952 = (0);
while(true){
if((i__5727__auto___11952 < len__5726__auto___11951)){
args__5732__auto__.push((arguments[i__5727__auto___11952]));

var G__11953 = (i__5727__auto___11952 + (1));
i__5727__auto___11952 = G__11953;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11947){
var vec__11948 = p__11947;
var ns_detector = cljs.core.nth.call(null,vec__11948,(0),null);
...
var G__11954 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11955 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11954;
remaining_tokens = G__11955;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11945){
var G__11946 = cljs.core.first.call(null,seq11945);
var seq11945__$1 = cljs.core.next.call(null,seq11945);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11946,seq11945__$1);
}));
...
var vec__11959 = cljs.core.split_with.call(null,(function (p1__11958_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11958_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11959,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11959,(1),null);
...
var vec__11965 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11965,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11965,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11968 = cljs.core.rest.call(null,remaining_tokens);
var G__11969 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11968;
name_tokens = G__11969;
continue;
} else {
...
var vec__11972 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11972,(0),null);
var arity = cljs.core.nth.call(null,vec__11972,(1),null);
var vec__11975 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11975,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11975,(1),null);
var vec__11978 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11978,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11978,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11978,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11978,(3),null);
...
var vec__11984 = result;
var munged_ns = cljs.core.nth.call(null,vec__11984,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11984,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11984,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11984,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11984,(4),null);
var arity = cljs.core.nth.call(null,vec__11984,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__11988 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__11988,(0),null);
var args = cljs.core.nth.call(null,vec__11988,(1),null);
var vec__11991 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11991,(0),null);
var name = cljs.core.nth.call(null,vec__11991,(1),null);
...
var G__11994 = (arity + (1));
var G__11995 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11996){
var vec__11997 = p__11996;
var arity = cljs.core.nth.call(null,vec__11997,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11997,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12000_SHARP_){
return cljs.core.get.call(null,arities,p1__12000_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12001_SHARP_){
return cljs.core.drop.call(null,(2),p1__12001_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___12008 = arguments.length;
var i__5727__auto___12009 = (0);
while(true){
if((i__5727__auto___12009 < len__5726__auto___12008)){
args__5732__auto__.push((arguments[i__5727__auto___12009]));

var G__12010 = (i__5727__auto___12009 + (1));
i__5727__auto___12009 = G__12010;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12004){
var vec__12005 = p__12004;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12005,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12002){
...
var G__12011 = arg;
var G__12011__$1 = (((G__12011 instanceof cljs.core.Keyword))?G__12011.fqn:null);
switch (G__12011__$1) {
...
var map__12013 = options;
var map__12013__$1 = cljs.core.__destructure_map.call(null,map__12013);
var include_ns_QMARK_ = cljs.core.get.call(null,map__12013__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12013__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12013__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12013__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12014 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12014,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12014,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12014,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12014,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12014,(4),null);
var arity = cljs.core.nth.call(null,vec__12014,(5),null);
...
var o__11782__auto__ = f;
return (o__11782__auto__["getBasis"]).call(o__11782__auto__);
});
/**
...
}catch (e12017){var _e__11789__auto__ = e12017;
...
var _STAR_ = (function (accum,p__12020){
...
var post_process = (function (p__12029){
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12028_SHARP_){
