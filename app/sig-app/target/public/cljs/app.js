...
window.CLOSURE_UNCOMPILED_DEFINES = {"goog.DEBUG":false,"cljs.core._STAR_global_STAR_":"window","figwheel.repl.connect_url":"ws:\/\/localhost:8081\/figwheel-connect?fwprocess=692452&fwbuild=compile-dev","cljs.core._STAR_target_STAR_":"bundle"};
...
document.write('<script>goog.require("sig_app.client");</script>');
