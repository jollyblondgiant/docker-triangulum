...
var G__11168 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__11168,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11170__i < G__11170__a.length) {G__11170__a[G__11170__i] = arguments[G__11170__i + 0]; ++G__11170__i;}
  args = new cljs.core.IndexedSeq(G__11170__a,0,null);
} 
...
var G__11172 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__11172,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11174__i < G__11174__a.length) {G__11174__a[G__11174__i] = arguments[G__11174__i + 0]; ++G__11174__i;}
  args = new cljs.core.IndexedSeq(G__11174__a,0,null);
} 
...
var G__11176 = props;
var G__11176__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11176,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11176);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11176__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__11177 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11177,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__11177;
}
})(),id_class);
...
var G__11178 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11178) {
case (0):
...
var vec__11180 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11180,(0),null);
var id = cljs.core.nth.call(null,vec__11180,(1),null);
var className = cljs.core.nth.call(null,vec__11180,(2),null);
...
var temp__5808__auto___11183 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___11183 == null)){
} else {
var key_11184 = temp__5808__auto___11183;
(jsprops.key = key_11184);
}
...
var temp__5808__auto___11185 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___11185 == null)){
} else {
var key_11186 = temp__5808__auto___11185;
(jsprops.key = key_11186);
}
...
var temp__5808__auto___11187 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___11187 == null)){
} else {
var key_11188 = temp__5808__auto___11187;
(jsprops.key = key_11188);
}
...
var temp__5808__auto___11189 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___11189 == null)){
} else {
var key_11190 = temp__5808__auto___11189;
(jsprops.key = key_11190);
}
...
var temp__5808__auto___11191 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___11191 == null)){
} else {
var key_11192 = temp__5808__auto___11191;
(jsprops.key = key_11192);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__11193_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__11193_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11194 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__11194,(0),null);
var derefed = cljs.core.nth.call(null,vec__11194,(1),null);
...
break;
default:
var G__11199 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__11200 = compiler;
v = G__11199;
compiler = G__11200;
continue;
...
var G__11201 = tag;
var G__11201__$1 = (((G__11201 instanceof cljs.core.Keyword))?G__11201.fqn:null);
switch (G__11201__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template11204 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template11204 = (function (opts,id,fn_to_element,parse_fn,meta11205){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11204.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11206,meta11205__$1){
var self__ = this;
var _11206__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11204(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11205__$1));
}));

(reagent.impl.template.t_reagent$impl$template11204.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11206){
var self__ = this;
var _11206__$1 = this;
return self__.meta11205;
}));

(reagent.impl.template.t_reagent$impl$template11204.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11204.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11204.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template11204.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11204.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11204.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11205","meta11205",1966486683,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11204.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11204.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11204");

(reagent.impl.template.t_reagent$impl$template11204.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write.call(null,writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template11204");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11204.
 */
reagent.impl.template.__GT_t_reagent$impl$template11204 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template11204(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta11205){
return (new reagent.impl.template.t_reagent$impl$template11204(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta11205));
});

}

return (new reagent.impl.template.t_reagent$impl$template11204(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
